...
// Standards-based static config (NIST SP 800-97, NIST SP 800-153, ITL Bulletin).
// Consumed by: backend/controllers/samController.js (modal detail API).
// CommonJS — required by the Express backend.
    ...
    recommendations: [
      {
        ...
        verbatimEvidence:
          "Open system authentication is a null authentication algorithm that involves a two-step authentication transaction.",
        technicalMeaning:
          "Open authentication does not verify identity, allowing rogue AP impersonation.",
        priority: "Immediate",
      ...
      },
      {
        ...
        verbatimEvidence:
          "Authentication mechanisms should ensure that devices connecting to the WLAN are properly validated.",
        technicalMeaning:
    ...
    recommendations: [
      {
        ...
        relatedThreatId: "WFVT-005",
        verbatimEvidence:
          "Early IEEE 802.11 security mechanisms had significant cryptographic weaknesses that could allow attackers to compromise confidentiality and integrity.",
        technicalMeaning:
          "Weak encryption enables interception and manipulation of data.",
        priority: "Immediate",
        responsible: "Network Administrator",
      },
      {
        ...
        relatedThreatId: "WFVT-007",
        verbatimEvidence:
          "Organizations should use strong cryptographic protections to secure wireless communications.",
        technicalMeaning:
          "Strong cryptography protects against exploitation of weak security controls.",
        priority: "Immediate",
        responsible: "Network Administrator",
      },
    ],
    ...
    recommendations: [
      {
        ...
        relatedThreatId: "WFVT-005",
        verbatimEvidence:
          "Organizations should configure wireless access points securely and disable unnecessary services.",
      ...
      },
      {
        ...
        relatedThreatId: "WFVT-007",
        verbatimEvidence:
          "Wireless networks should be securely configured and unnecessary features should be disabled.",
    ...
    recommendations: [
      {
        ...
        verbatimEvidence:
          "Management frames in IEEE 802.11 networks were originally not protected, allowing attackers to forge management frames such as deauthentication and disassociation frames.",
        technicalMeaning:
          "Attackers can spoof deauthentication frames to disconnect users.",
        priority: "Immediate",
        responsible: "Network Administrator",
      },
      {
        ...
        relatedThreatId: "WFVT-006",
        verbatimEvidence:
          "Unprotected management frames can be exploited by attackers to disrupt wireless communications.",
      ...
      },
      {
        ...
        relatedThreatId: "WFVT-005",
        verbatimEvidence:
          "Security mechanisms should be implemented to prevent unauthorized access points and malicious wireless activity.",
        technicalMeaning:
          "PMF helps prevent rogue interference and control manipulation.",
        priority: "Immediate",
        responsible: "Network Administrator",
      },
    ],
